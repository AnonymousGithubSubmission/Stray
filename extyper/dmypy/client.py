...
from extyper.dmypy_util import DEFAULT_STATUS_FILE, receive
from extyper.ipc import IPCClient, IPCException
from extyper.dmypy_os import alive, kill
from extyper.util import check_python_version, get_terminal_width
...
def start_server(args: argparse.Namespace, allow_sources: bool = False) -> None:
    ...
    from extyper.dmypy_server import daemonize, process_start_options
...
def check_output(response: Dict[str, Any], verbose: bool,
    ...
    if junit_xml:
        ...
        from extyper.util import write_junit_xml
...
def do_daemon(args: argparse.Namespace) -> None:
    ...
    # Lazy import so this import doesn't slow down other commands.
    from extyper.dmypy_server import Server, process_start_options
