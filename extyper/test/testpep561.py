...
import extyper.api
from extyper.test.config import package_path
from extyper.util import try_find_python2_interpreter
from extyper.test.data import DataDrivenTestCase, DataSuite
from extyper.test.config import test_temp_dir
from extyper.test.helpers import assert_string_arrays_equal, perform_file_operations
...
def test_pep561(testcase: DataDrivenTestCase) -> None:
    ...
    with virtualenv(python) as venv:
        ...
        for i, operations in enumerate(steps):
            ...
            out, err, returncode = extyper.api.run(cmd_line)
