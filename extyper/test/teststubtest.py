...
import extyper.stubtest
from extyper.stubtest import parse_options, test_stubs
from extyper.test.data import root_dir
...
class StubtestMiscUnit(unittest.TestCase):
    ...
    def test_get_typeshed_stdlib_modules(self) -> None:
        stdlib = extyper.stubtest.get_typeshed_stdlib_modules(None)
    ...
    def test_signature(self) -> None:
        ...
        assert (
            str(extyper.stubtest.Signature.from_inspect_signature(inspect.signature(f)))
            == "def (a, b, *, c, d = ..., **kwargs)"
        )
